...
xlab("PC1") + ylab("PC2") +
theme(plot.title=element_text(size=14, face="bold.italic", hjust=0.7), axis.title.x=element_text(size=14, face="bold"), axis.title.y=element_text(size=14, face="bold")) +
